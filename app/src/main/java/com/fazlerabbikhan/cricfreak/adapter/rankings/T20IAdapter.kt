...
class T20IAdapter(
...
) : RecyclerView.Adapter<T20IAdapter.T10IViewHolder>() {

    class T10IViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): T10IViewHolder {
        val adapterLayout = LayoutInflater.from(parent.context)
            .inflate(R.layout.card_rankings, parent, false)
        return T10IViewHolder(adapterLayout)
    }

    override fun onBindViewHolder(holder: T10IViewHolder, position: Int) {
