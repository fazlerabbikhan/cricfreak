...
class ODIAdapter(
...
) : RecyclerView.Adapter<ODIAdapter.ODIViewHolder>() {

    class ODIViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ODIViewHolder {
        val adapterLayout = LayoutInflater.from(parent.context)
            .inflate(R.layout.card_rankings, parent, false)
        return ODIViewHolder(adapterLayout)
    }

    override fun onBindViewHolder(holder: ODIViewHolder, position: Int) {
